...
function ExcluirAlert({ onConfirm, onCancel, nomeDoContato }) {
  return (
    <div className="fixed bg-blue-500/30 inset-0 flex items-center justify-center z-50">
      <div className="bg-white p-4 rounded-lg shadow-lg">
        <p className="text-gray-800 text-lg mb-4 text-center">Tem certeza de que deseja excluir o contato do {nomeDoContato}?</p>
